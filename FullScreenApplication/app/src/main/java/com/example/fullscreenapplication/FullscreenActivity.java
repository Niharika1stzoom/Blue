...
import com.example.fullscreenapplication.databinding.ActivityFullscreenBinding;
...
public class FullscreenActivity extends AppCompatActivity {
    ...
    private boolean mButttonVisible;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVisible = true;
        mButttonVisible=false;
        mControlsView = binding.fullscreenContentControls;
        mContentView = binding.fullscreenContent;
        showWebContent("https://samplelib.com/lib/preview/mp4/sample-5s.mp4");
      ...
      /*  mContentView.setOnClickListener(new View.OnClickListener() {
        ...
        binding.dummyButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.d("Full","I am a dummy button");
            }
        });
    ...
    public void onBackPressed() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.yes, (dialog, which) -> {
                    showWebContent("https://www.google.com");
                })
